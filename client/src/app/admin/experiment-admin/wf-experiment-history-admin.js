 ...
 */
angular.module('wellFollowed').directive('wfExperimentHistoryAdmin', function (Experiment, $wfModal, $filter) {
    return {
        restrict: 'E',
        templateUrl: 'admin/experiment-admin/wf-experiment-history-admin.html',
        link: function (scope, element, attributes) {
            ...
            scope.download = function(experimentId) {
                $wfModal.open({
                    scope: scope,
                    directiveName: 'wf-experiment-history-download-modal-admin',
                    data: {
