 ...
 */
angular.module('wellFollowed').directive('wfExperimentAdmin', function (Sensor, $wfStream, LiveSet, Experiment, WfUser, Event, wfEventTypes) {
    return {
        restrict: 'E',
        templateUrl: 'admin/experiment-admin/wf-experiment-admin.html',
        require: ['^wfApp'],
