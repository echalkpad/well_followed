 ...
 */
angular.module('wellFollowed').directive('wfSensorNumericAdmin', function($wfStream, SensorData, $window) {
    return {
        restrict: 'E',
        templateUrl: 'admin/experiment-admin/wf-sensor-numeric-admin.html',
        require: '^wfSensor',
