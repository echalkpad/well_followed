 ...
 */
angular.module('wellFollowed').directive('wfSensorAdmin', function(SensorData, $wfStream, $compile, $injector) {
    return {
        restrict: 'E',
        templateUrl: 'admin/experiment-admin/wf-sensor-admin.html',
        scope: {
            sensor: '='
        },
        ...
        link: function(scope, element, attributes) {
            ...
            var directiveName = 'wfSensorAdmin' + type.charAt(0).toUpperCase() + type.slice(1);
            ...
            if ($injector.has(directiveName + 'Directive') && type != 'notImplemented') {
                ...
                html = angular.element('<wf-sensor-not-implemented-admin style="display: block"></wf-sensor-not-implemented-admin>')
            }
